...
new_resales['year'] = new_resales['year'] - current_year
...
new_resales['Inflation_rate'] = new_resales['year'].map(Inflation_rates)

regression_columns = ['year', 'flat_type', 'storey_range', 'town',
                      'remaining_lease', 'floor_area_sqm', 'resale_price', 'Inflation_rate']
...
resales_after_2020 = new_resales_reg[new_resales_reg['year']>=(2010-current_year)].reset_index(drop=True)
